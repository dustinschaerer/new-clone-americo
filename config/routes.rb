...
Americo::Application.routes.draw do
  ...
  constraints(:host => "americo-inc.com") do
    ...
    get "(*x)" => redirect { |params, request|
      URI.parse(request.url).tap { |x| x.host = "www.americo-inc.com" }.to_s
    }
  end
 ...
 # match '/contact',   to: 'static_pages#contact', via: 'get'
  ...
  match '/order_submitted', to: 'static_pages#order_submitted', via: 'get'
  ...
  match '/purchase_completed',   to: 'static_pages#purchase_completed', via: 'get'
  match '/quote_requested',   to: 'static_pages#quote_requested', via: 'get'
